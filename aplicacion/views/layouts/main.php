...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title>Tu Asesor Financiero</title>
    <?php $this->head();
...
SCRIPT;
    ...
    <meta name="apple-mobile-web-app-title" content="Tu Asesor Financiero">
    <meta name="application-name" content="Tu Asesor Financiero">
...
<?php $this->beginBody() ?>
    <div class="wrap">
        <?php
            NavBar::begin([
                'brandLabel' => '<img src="'.Yii::$app->request->baseUrl.'/images/logo-icon.png" style="height:20px;float:left;margin-right: 5px" align="absbottom">  Tu Asesor Financiero',
    ...
    <footer class="footer">
        <div class="container" align="center">
            <?= Html::a('Tu Asesor Financiero', '#', ['target'=>'_blank']) ?> &copy; <?= date('Y') ?>  
